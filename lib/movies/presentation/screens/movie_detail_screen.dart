...
import 'package:movies_app/movies/presentation/controllers/movie%20details%20bloc/movie_details_bloc.dart';
    ...
    return BlocBuilder<MovieDetailsBloc, MovieDetailsState>(
      builder: (context, state) {
        return switch (state.movieDetailsState) {
          ...
          RequestStates.loaded => CustomScrollView(
    ...
    return BlocBuilder<MovieDetailsBloc, MovieDetailsState>(
      builder: (context, state) {
        return switch (state.movieDetailsState) {
          ...
          RequestStates.loaded => SliverGrid(
